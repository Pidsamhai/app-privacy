<div class="tw-prose no-tailwindcss-base">
	<h1>Movie DB Privacy Policy</h1>
	<p>Last updated: Oct 3, 2023</p>
	<p>
	...
	<ul>
		...
		<li>
			<p>
				...
				You on any electronic device, named Movie DB
			</p>
		</li>
		<li>
			<p>
	...
	<ul>
		<li>By email: dev.psm.crop@gmail.com</li>
	</ul>
</div>
